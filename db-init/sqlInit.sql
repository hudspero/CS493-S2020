...
CREATE TABLE `course` (
  ...
  CONSTRAINT `instructorClass` FOREIGN KEY (`instructorId`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `submission` (
  ...
  CONSTRAINT `submissionAssignment` FOREIGN KEY (`assignmentid`) REFERENCES `assignment` (`id`),
  CONSTRAINT `submissionStudent` FOREIGN KEY (`studentid`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-06-02 20:02:34
